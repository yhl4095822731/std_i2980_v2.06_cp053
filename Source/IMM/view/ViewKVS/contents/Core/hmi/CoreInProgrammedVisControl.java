 ...
 * 
 * Checks for <code>sv_MoveIn.bProgrammedInSequence</code>
 *
 */
public class CoreInProgrammedVisControl extends ODCActiveAndAnyMoveController {
   
   private static final Category LOG = Category.getInstance(CoreInProgrammedVisControl.class.getName());
   private KBoolean kboolAutoCycleRunning = null;
   
   public CoreInProgrammedVisControl() {
      try{
