 ...
 * 
 */
public class DecompIntPosTimeVisControl implements VisibilityCtrlInterface2, IInstanceProperty {

   private static final Category LOG = Category.getInstance(DecompIntPosTimeVisControl.class.getName());
   ...
   public boolean isEnabled() {
      if (kvarDecompMode != null && kvarDecompMode.getIntValue() == 0) {
         // mode is time!
         return true;
      }
      return false;
